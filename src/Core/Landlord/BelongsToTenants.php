...
namespace Callcocam\LaraGatekeeper\Core\Landlord;

use Callcocam\LaraGatekeeper\Core\Landlord\Exceptions\ModelNotFoundForTenantException;
...
trait BelongsToTenants
{
    ...
    {
        return isset($this->tenantColumns) ? $this->tenantColumns : config('landlord.default_tenant_columns', ['tenant_id']);
    }
