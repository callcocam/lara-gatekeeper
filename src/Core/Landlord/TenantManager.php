...
use Callcocam\LaraGatekeeper\Core\Landlord\Exceptions\TenantColumnUnknownException;
use Callcocam\LaraGatekeeper\Core\Landlord\Exceptions\TenantNullIdException;
