 ...
 */
namespace Callcocam\LaraGatekeeper\Core\Shinobi\Concerns;

use Illuminate\Support\Arr;
use Callcocam\LaraGatekeeper\Core\Shinobi\Facades\Shinobi;
use Callcocam\LaraGatekeeper\Core\Shinobi\Contracts\Permission;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Callcocam\LaraGatekeeper\Core\Shinobi\Exceptions\PermissionNotFoundException;
use Callcocam\LaraGatekeeper\Models\Permission as ModelsPermission;
...
trait HasPermissions
{
     ...
     * 
     * @param  \Callcocam\LaraGatekeeper\Core\Shinobi\Models\Permission  $permission
     * @return boolean
     */
